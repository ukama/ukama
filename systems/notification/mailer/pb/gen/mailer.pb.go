...
var file_mailer_proto_depIdxs = []int32{
	0, // 0: ukama.notification.mailer.v1.MaillingService.SendEmail:input_type -> ukama.notification.mailer.v1.SendEmailRequest
	1, // 1: ukama.notification.mailer.v1.MaillingService.SendEmail:output_type -> ukama.notification.mailer.v1.SendEmailResponse
