...
// GetMemberByUserId provides a mock function with given fields: orgName, uuid
func (_m *RegistryProvider) GetMemberByUserId(orgName string, uuid string) (*gen.MemberResponse, error) {
