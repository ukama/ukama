...
func runGrpcServer(gormdb sql.Db) {
	...
	//TODO: We need to perform InitClient resolutions on demand, in order to avoid url changes.
	...
	subUrl, err := ic.GetApiGwAddress(ic.NewInitClient(serviceConfig.Http.InitClient, client.WithDebug(serviceConfig.DebugMode)),
