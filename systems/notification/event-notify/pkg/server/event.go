...
func (es *EventToNotifyEventServer) ProcessEvent(ec *evt.EventConfig, orgId, networkId, nodeId, subscriberId, userId ,resourceId string , msg []byte) *db.Notification {
