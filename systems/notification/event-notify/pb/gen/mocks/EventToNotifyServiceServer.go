...
type mockConstructorTestingTNewEventToNotifyServiceServer interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewEventToNotifyServiceServer(t mockConstructorTestingTNewEventToNotifyServiceServer) *EventToNotifyServiceServer {
