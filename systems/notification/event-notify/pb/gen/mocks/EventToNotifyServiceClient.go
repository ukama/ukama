...
// NotificationsStream provides a mock function with given fields: ctx, in, opts
func (_m *EventToNotifyServiceClient) NotificationsStream(ctx context.Context, in *gen.NotificationsStreamRequest, opts ...grpc.CallOption) (gen.EventToNotifyService_NotificationsStreamClient, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
	...
	var r0 gen.EventToNotifyService_NotificationsStreamClient
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *gen.NotificationsStreamRequest, ...grpc.CallOption) (gen.EventToNotifyService_NotificationsStreamClient, error)); ok {
		return rf(ctx, in, opts...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *gen.NotificationsStreamRequest, ...grpc.CallOption) gen.EventToNotifyService_NotificationsStreamClient); ok {
		r0 = rf(ctx, in, opts...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(gen.EventToNotifyService_NotificationsStreamClient)
		}
	}

	if rf, ok := ret.Get(1).(func(context.Context, *gen.NotificationsStreamRequest, ...grpc.CallOption) error); ok {
		r1 = rf(ctx, in, opts...)
	} else {
		r1 = ret.Error(1)
	}
