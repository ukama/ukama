...
import (
	...
	gen "github.com/ukama/ukama/systems/data_plan/package/pb/gen"

	pb "github.com/ukama/ukama/systems/data_plan/base-rate/pb"
)
...
func (_m *dataPlan) GetPackage(req *gen.GetPackageRequest) (*gen.GetPackageResponse, error) {
	ret := _m.Called(req)

	var r0 *gen.GetPackageResponse
	if rf, ok := ret.Get(0).(func(*gen.GetPackageRequest) *gen.GetPackageResponse); ok {
		r0 = rf(req)
	} else {
		if ret.Get(0) != nil {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(*gen.GetPackageRequest) error); ok {
		r1 = rf(req)
	} else {
		r1 = ret.Error(1)
	}
...
// GetPackageByOrg provides a mock function with given fields: req
func (_m *dataPlan) GetPackageByOrg(req *gen.GetByOrgPackageRequest) (*gen.GetByOrgPackageResponse, error) {
	ret := _m.Called(req)

	var r0 *gen.GetByOrgPackageResponse
	if rf, ok := ret.Get(0).(func(*gen.GetByOrgPackageRequest) *gen.GetByOrgPackageResponse); ok {
		r0 = rf(req)
	} else {
		if ret.Get(0) != nil {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(*gen.GetByOrgPackageRequest) error); ok {
		r1 = rf(req)
	} else {
		r1 = ret.Error(1)
	}
