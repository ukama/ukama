...
import (
	...
	"github.com/ukama/ukama/systems/data_plan/api-gateway/cmd/version"
	"github.com/ukama/ukama/systems/data_plan/api-gateway/pkg"
	"github.com/ukama/ukama/systems/data_plan/api-gateway/pkg/client"
	pbBaseRate "github.com/ukama/ukama/systems/data_plan/base_rate/pb"
...
func (r *Router) init() {
	...
	v1 := r.f.Group("/v1", "Data_plan system ", "Data_plan  system version v1")
