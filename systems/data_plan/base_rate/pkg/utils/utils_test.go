...
func TestRateService_FetchData_Success(t *testing.T) {
	mockFileUrl := "https://raw.githubusercontent.com/ukama/ukama/main/systems/data_plan/docs/template/template.csv"
...
func TestRateService_FetchData_error2(t *testing.T) {
	failMockFileUrl := "https://raw.githubusercontent.com/ukama/ukama/baserate-test/systems/data_plan/docs/template/failed_template.csv"
