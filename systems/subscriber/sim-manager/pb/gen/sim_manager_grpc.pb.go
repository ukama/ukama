...
const (
	...
	SimManagerService_TerminateSimsForSubscriber_FullMethodName = "/ukama.subscriber.sim_manager.v1.SimManagerService/TerminateSimsForSubscriber"
...
type SimManagerServiceClient interface {
	...
	// This new methods will terminatSims and packages for subscriber
	TerminateSimsForSubscriber(ctx context.Context, in *TerminateSimsForSubscriberRequest, opts ...grpc.CallOption) (*TerminateSimsForSubscriberResponse, error)
	// Sim package
...
func (c *simManagerServiceClient) TerminateSimsForSubscriber(ctx context.Context, in *TerminateSimsForSubscriberRequest, opts ...grpc.CallOption) (*TerminateSimsForSubscriberResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(TerminateSimsForSubscriberResponse)
	err := c.cc.Invoke(ctx, SimManagerService_TerminateSimsForSubscriber_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *simManagerServiceClient) SetActivePackageForSim(ctx context.Context, in *SetActivePackageRequest, opts ...grpc.CallOption) (*SetActivePackageResponse, error) {
	...
	err := c.cc.Invoke(ctx, SimManagerService_SetActivePackageForSim_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type SimManagerServiceServer interface {
	...
	// This new methods will terminatSims and packages for subscriber
	TerminateSimsForSubscriber(context.Context, *TerminateSimsForSubscriberRequest) (*TerminateSimsForSubscriberResponse, error)
	// Sim package
...
func (UnimplementedSimManagerServiceServer) TerminateSimsForSubscriber(context.Context, *TerminateSimsForSubscriberRequest) (*TerminateSimsForSubscriberResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method TerminateSimsForSubscriber not implemented")
}
...
func RegisterSimManagerServiceServer(s grpc.ServiceRegistrar, srv SimManagerServiceServer) {
	// If the following call pancis, it indicates UnimplementedSimManagerServiceServer was
...
func _SimManagerService_TerminateSimsForSubscriber_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(TerminateSimsForSubscriberRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SimManagerServiceServer).TerminateSimsForSubscriber(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: SimManagerService_TerminateSimsForSubscriber_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SimManagerServiceServer).TerminateSimsForSubscriber(ctx, req.(*TerminateSimsForSubscriberRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var SimManagerService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "TerminateSimsForSubscriber",
			Handler:    _SimManagerService_TerminateSimsForSubscriber_Handler,
		},
		{
