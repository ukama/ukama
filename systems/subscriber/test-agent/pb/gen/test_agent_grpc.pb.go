...
func (c *testAgentServiceClient) BindSim(ctx context.Context, in *BindSimRequest, opts ...grpc.CallOption) (*BindSimResponse, error) {
	...
	err := c.cc.Invoke(ctx, TestAgentService_BindSim_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *testAgentServiceClient) GetSim(ctx context.Context, in *GetSimRequest, opts ...grpc.CallOption) (*GetSimResponse, error) {
	...
	err := c.cc.Invoke(ctx, TestAgentService_GetSim_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *testAgentServiceClient) ActivateSim(ctx context.Context, in *ActivateSimRequest, opts ...grpc.CallOption) (*ActivateSimResponse, error) {
	...
	err := c.cc.Invoke(ctx, TestAgentService_ActivateSim_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *testAgentServiceClient) DeactivateSim(ctx context.Context, in *DeactivateSimRequest, opts ...grpc.CallOption) (*DeactivateSimResponse, error) {
	...
	err := c.cc.Invoke(ctx, TestAgentService_DeactivateSim_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *testAgentServiceClient) TerminateSim(ctx context.Context, in *TerminateSimRequest, opts ...grpc.CallOption) (*TerminateSimResponse, error) {
	...
	err := c.cc.Invoke(ctx, TestAgentService_TerminateSim_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedTestAgentServiceServer) BindSim(context.Context, *BindSimRequest) (*BindSimResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method BindSim not implemented")
}
...
func (UnimplementedTestAgentServiceServer) ActivateSim(context.Context, *ActivateSimRequest) (*ActivateSimResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ActivateSim not implemented")
}
func (UnimplementedTestAgentServiceServer) DeactivateSim(context.Context, *DeactivateSimRequest) (*DeactivateSimResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method DeactivateSim not implemented")
}
...
func RegisterTestAgentServiceServer(s grpc.ServiceRegistrar, srv TestAgentServiceServer) {
	// If the following call panics, it indicates UnimplementedTestAgentServiceServer was
