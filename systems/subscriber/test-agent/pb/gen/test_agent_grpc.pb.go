...
func (c *testAgentServiceClient) BindSim(ctx context.Context, in *BindSimRequest, opts ...grpc.CallOption) (*BindSimResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/ukama.subscriber.test_agent.v1.TestAgentService/BindSim", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _TestAgentService_BindSim_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ukama.subscriber.test_agent.v1.TestAgentService/BindSim",
	}
