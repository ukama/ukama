...
// SimPoolServiceClient is an autogenerated mock type for the SimPoolServiceClient type
type SimPoolServiceClient struct {
	mock.Mock
}

// Add provides a mock function with given fields: ctx, in, opts
func (_m *SimPoolServiceClient) Add(ctx context.Context, in *gen.AddRequest, opts ...grpc.CallOption) (*gen.AddResponse, error) {
...
func (_m *SimPoolServiceClient) Delete(ctx context.Context, in *gen.DeleteRequest, opts ...grpc.CallOption) (*gen.DeleteResponse, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
...
func (_m *SimPoolServiceClient) GetStats(ctx context.Context, in *gen.GetStatsRequest, opts ...grpc.CallOption) (*gen.GetStatsResponse, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
...
func (_m *SimPoolServiceClient) Upload(ctx context.Context, in *gen.UploadRequest, opts ...grpc.CallOption) (*gen.UploadResponse, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
...
type mockConstructorTestingTNewSimPoolServiceClient interface {
	mock.TestingT
	Cleanup(func())
}

// NewSimPoolServiceClient creates a new instance of SimPoolServiceClient. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
func NewSimPoolServiceClient(t mockConstructorTestingTNewSimPoolServiceClient) *SimPoolServiceClient {
	mock := &SimPoolServiceClient{}
	mock.Mock.Test(t)
