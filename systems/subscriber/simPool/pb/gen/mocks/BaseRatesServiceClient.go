...
func (_m *BaseRatesServiceClient) Add(ctx context.Context, in *gen.AddRequest, opts ...grpc.CallOption) (*gen.AddResponse, error) {
...
func (_m *BaseRatesServiceClient) Delete(ctx context.Context, in *gen.DeleteRequest, opts ...grpc.CallOption) (*gen.DeleteResponse, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
...
func (_m *BaseRatesServiceClient) GetStats(ctx context.Context, in *gen.GetStatsRequest, opts ...grpc.CallOption) (*gen.GetStatsResponse, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
...
func (_m *BaseRatesServiceClient) Upload(ctx context.Context, in *gen.UploadRequest, opts ...grpc.CallOption) (*gen.UploadResponse, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
