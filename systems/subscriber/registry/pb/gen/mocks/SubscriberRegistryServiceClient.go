...
func (_m *SubscriberRegistryServiceClient) GetByNetwork(ctx context.Context, in *gen.GetByNetworkRequest, opts ...grpc.CallOption) (*gen.GetByNetworkResponse, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
...
func (_m *SubscriberRegistryServiceClient) ListSubscribers(ctx context.Context, in *gen.ListSubscribersRequest, opts ...grpc.CallOption) (*gen.ListSubscribersResponse, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
...
func (_m *SubscriberRegistryServiceClient) Update(ctx context.Context, in *gen.UpdateSubscriberRequest, opts ...grpc.CallOption) (*gen.UpdateSubscriberResponse, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
