...
func (_m *RegistryServiceClient) Add(ctx context.Context, in *gen.AddSubscriberRequest, opts ...grpc.CallOption) (*gen.AddSubscriberResponse, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *gen.AddSubscriberRequest, ...grpc.CallOption) (*gen.AddSubscriberResponse, error)); ok {
...
func (_m *RegistryServiceClient) Delete(ctx context.Context, in *gen.DeleteSubscriberRequest, opts ...grpc.CallOption) (*gen.DeleteSubscriberResponse, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *gen.DeleteSubscriberRequest, ...grpc.CallOption) (*gen.DeleteSubscriberResponse, error)); ok {
		return rf(ctx, in, opts...)
	}
...
func (_m *RegistryServiceClient) Get(ctx context.Context, in *gen.GetSubscriberRequest, opts ...grpc.CallOption) (*gen.GetSubscriberResponse, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *gen.GetSubscriberRequest, ...grpc.CallOption) (*gen.GetSubscriberResponse, error)); ok {
		return rf(ctx, in, opts...)
	}
...
func (_m *RegistryServiceClient) GetByEmail(ctx context.Context, in *gen.GetSubscriberByEmailRequest, opts ...grpc.CallOption) (*gen.GetSubscriberByEmailResponse, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *gen.GetSubscriberByEmailRequest, ...grpc.CallOption) (*gen.GetSubscriberByEmailResponse, error)); ok {
		return rf(ctx, in, opts...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *gen.GetSubscriberByEmailRequest, ...grpc.CallOption) *gen.GetSubscriberByEmailResponse); ok {
		r0 = rf(ctx, in, opts...)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(context.Context, *gen.GetSubscriberByEmailRequest, ...grpc.CallOption) error); ok {
		r1 = rf(ctx, in, opts...)
	} else {
		r1 = ret.Error(1)
	}
...
func (_m *RegistryServiceClient) GetByNetwork(ctx context.Context, in *gen.GetByNetworkRequest, opts ...grpc.CallOption) (*gen.GetByNetworkResponse, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *gen.GetByNetworkRequest, ...grpc.CallOption) (*gen.GetByNetworkResponse, error)); ok {
		return rf(ctx, in, opts...)
	}
...
func (_m *RegistryServiceClient) ListSubscribers(ctx context.Context, in *gen.ListSubscribersRequest, opts ...grpc.CallOption) (*gen.ListSubscribersResponse, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *gen.ListSubscribersRequest, ...grpc.CallOption) (*gen.ListSubscribersResponse, error)); ok {
		return rf(ctx, in, opts...)
	}
...
func (_m *RegistryServiceClient) Update(ctx context.Context, in *gen.UpdateSubscriberRequest, opts ...grpc.CallOption) (*gen.UpdateSubscriberResponse, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *gen.UpdateSubscriberRequest, ...grpc.CallOption) (*gen.UpdateSubscriberResponse, error)); ok {
		return rf(ctx, in, opts...)
	}
...
func NewRegistryServiceClient(t interface {
	mock.TestingT
	Cleanup(func())
