...
func (_m *NetworkClient) Add(req rest.AddNetworkRequest) (*rest.NetworkInfo, error) {
	ret := _m.Called(req)
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(rest.AddNetworkRequest) (*rest.NetworkInfo, error)); ok {
		return rf(req)
	}
	if rf, ok := ret.Get(0).(func(rest.AddNetworkRequest) *rest.NetworkInfo); ok {
		r0 = rf(req)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(rest.AddNetworkRequest) error); ok {
		r1 = rf(req)
	} else {
		r1 = ret.Error(1)
	}
...
func (_m *NetworkClient) Get(Id string) (*rest.NetworkInfo, error) {
	ret := _m.Called(Id)
