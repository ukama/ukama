...
func (_m *Sim) ConfigureSim(_a0 string, _a1 string, _a2 string, _a3 string, _a4 string, _a5 string, _a6 string, _a7 string, _a8 string, _a9 string, _a10 string, _a11 string, _a12 string, _a13 string, _a14 uint32) (*client.SimInfo, error) {
...
func (_m *Sim) GetSim(_a0 string) (*client.SimInfo, error) {
	ret := _m.Called(_a0)
