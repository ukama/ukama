...
func (_m *Network) CreateNetwork(_a0 string, _a1 string, _a2 []string, _a3 []string, _a4 float64, _a5 float64, _a6 uint32, _a7 bool) (*client.NetworkInfo, error) {
...
func (_m *Network) GetNetwork(_a0 string) (*client.NetworkInfo, error) {
	ret := _m.Called(_a0)
