...
func (r *Router) postNetwork(c *gin.Context, req *AddNetworkReq) (*cclient.NetworkInfo, error) {
...
func (r *Router) getNetwork(c *gin.Context, req *GetNetworkReq) (*cclient.NetworkInfo, error) {
	return r.network.GetNetwork(req.NetworkId)
}

func (r *Router) postPackage(c *gin.Context, req *AddPackageReq) (*cclient.PackageInfo, error) {
...
func (r *Router) getPackage(c *gin.Context, req *GetPackageReq) (*cclient.PackageInfo, error) {
	return r.pkg.GetPackage(req.PackageId)
}

func (r *Router) postSim(c *gin.Context, req *AddSimReq) (*cclient.SimInfo, error) {
...
func (r *Router) getSim(c *gin.Context, req *GetSimReq) (*cclient.SimInfo, error) {
	return r.sim.GetSim(req.Id)
}

func (r *Router) getNode(c *gin.Context, req *GetNodeRequest) (*cclient.NodeInfo, error) {
	return r.node.GetNode(req.NodeId)
}

func (r *Router) postNode(c *gin.Context, req *AddNodeRequest) (*cclient.NodeInfo, error) {
