...
const file_events_cdr_proto_rawDesc = "" +
	"\n" +
	"\x10events/cdr.proto\x12\x0fukama.events.v1\x1a\x0fvalidator.proto\"\xdf\x01\n" +
	"\vNodeChanged\x12)\n" +
	...
	"\tOldNodeId\x18\x06 \x01(\tR\tOldNodeId\"\xc8\x01\n" +
	...
	"\x06NodeId\x18\x05 \x01(\tR\x06NodeId\x12\x1c\n" +
	"\tSessionId\x18\x06 \x01(\x04R\tSessionId\"\xed\x02\n" +
	...
	"\n" +
	"TotalBytes\x18\f \x01(\x04R\vtotal_bytes\"\xf0\x01\n" +
	"\x10SessionDestroyed\x12)\n" +
	"\x04imsi\x18\x01 \x01(\tB\x15\xe2\xdf\x1f\x11\n" +
	"\r^[0-9]{6,15}$X\x01R\x04imsi\x12!\n" +
	"\x06Policy\x18\x02 \x01(\tB\t\xe2\xdf\x1f\x05X\x01\x90\x01\x04R\x06policy\x12\x14\n" +
