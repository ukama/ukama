...
var file_events_accounting_proto_goTypes = []interface{}{
...
func file_events_accounting_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_events_accounting_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*UserAccountingEvent); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_events_accounting_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*UserAccounting); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
