...
const file_events_warehouse_proto_rawDesc = "" +
	"\n" +
	"\x16events/warehouse.proto\x12\x0fukama.events.v1\x1a\x0fvalidator.proto\"\x96\x02\n" +
	"\x11InventorySimEvent\x12,\n" +
	"\x05iccid\x18\x01 \x01(\tB\x16\xe2\xdf\x1f\x12\n" +
	"\x0e^[0-9]{18,22}$X\x01R\x05iccid\x12)\n" +
	"\x04imsi\x18\x02 \x01(\tB\x15\xe2\xdf\x1f\x11\n" +
	"\r^[0-9]{6,15}$X\x01R\x04imsi\x12\x19\n" +
