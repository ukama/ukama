...
// NewIMsgBus creates a new instance of IMsgBus. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewIMsgBus(t testing.TB) *IMsgBus {
	mock := &IMsgBus{}
	mock.Mock.Test(t)
