...
func (_m *UkamaAgentClient) DeleteProfile(req client.AgentRequestData) error {
	ret := _m.Called(req)
...
// GetUsages provides a mock function with given fields: iccid, simPackageIds, cdrType, from, to, region
func (_m *UkamaAgentClient) GetUsages(iccid string, simPackageIds []string, cdrType string, from string, to string, region string) (map[string]interface{}, map[string]interface{}, error) {
	ret := _m.Called(iccid, simPackageIds, cdrType, from, to, region)
	...
	var r2 error
	if rf, ok := ret.Get(0).(func(string, []string, string, string, string, string) (map[string]interface{}, map[string]interface{}, error)); ok {
		return rf(iccid, simPackageIds, cdrType, from, to, region)
	}
	if rf, ok := ret.Get(0).(func(string, []string, string, string, string, string) map[string]interface{}); ok {
		r0 = rf(iccid, simPackageIds, cdrType, from, to, region)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(string, []string, string, string, string, string) map[string]interface{}); ok {
		r1 = rf(iccid, simPackageIds, cdrType, from, to, region)
	} else {
		if ret.Get(1) != nil {
	...
	if rf, ok := ret.Get(2).(func(string, []string, string, string, string, string) error); ok {
		r2 = rf(iccid, simPackageIds, cdrType, from, to, region)
	} else {
		r2 = ret.Error(2)
	}
