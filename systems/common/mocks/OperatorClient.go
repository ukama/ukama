...
import (
	...
	operator "github.com/ukama/ukama/systems/common/rest/client/operatoragent"
)
...
func (_m *OperatorClient) GetUsages(iccid string, cdrType string, from string, to string, region string) (map[string]any, map[string]any, error) {
	...
	var r2 error
	if rf, ok := ret.Get(0).(func(string, string, string, string, string) (map[string]any, map[string]any, error)); ok {
		return rf(iccid, cdrType, from, to, region)
	}
	if rf, ok := ret.Get(0).(func(string, string, string, string, string) map[string]any); ok {
	...
	if rf, ok := ret.Get(1).(func(string, string, string, string, string) map[string]any); ok {
