...
var EventRoutingKey = [...]string{
	...
	EventPaymentProcessUpdate: "event.cloud.local.{{ .Org}}.payment.processor.payment.update",
}
...
var EventToEventConfig = map[EventId]EventConfig{
	...
	EventPaymentProcessUpdate: {
		Key:         EventPaymentProcessUpdate,
		Name:        "EventPaymentProcessUpdate",
		Title:       "Payment process updated",
		Description: "Payment process updated",
		Scope:       notif.SCOPE_SUBSCRIBER,
		Type:        TypeDefault,
	},
}
