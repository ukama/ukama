...
func (s NodeState) String() string {
	t := map[NodeState]string{0: "undefined", 1: "onboarding", 2: "configure", 3: "operational", 4: "faulty"}
...
func ParseNodeState(value string) NodeState {
	...
	t := map[string]CdrType{"undefined": 0, "onboarding": 1, "configure": 2, "operational": 3, "faulty": 4}
