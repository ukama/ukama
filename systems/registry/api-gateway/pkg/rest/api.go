...
type ListNodesRequest struct {
	...
	State        string `json:"state,omitempty" validate:"omitempty,eq=unknown|eq=configuring|eq=operational|eq=faulty|eq=initializing|eq=ready|eq=updating|eq=offboarded" query:"state" enums:"unknown,configuring,operational,faulty,initializing,ready,updating,offboarded"`
...
type GetNodesByStateRequest struct {
	...
	State        string `form:"state" json:"state,omitempty" validate:"eq=unknown|eq=configuring|eq=operational|eq=faulty|eq=initializing|eq=ready|eq=updating|eq=offboarded" query:"state" binding:"required"`
}
