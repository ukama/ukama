...
// GetRunningOrg provides a mock function with given fields: _a0, _a1
func (_m *OrgServiceServer) GetRunningOrg(_a0 context.Context, _a1 *gen.GetRunningOrgRequest) (*gen.GetRunningOrgResponse, error) {
	ret := _m.Called(_a0, _a1)

	var r0 *gen.GetRunningOrgResponse
	if rf, ok := ret.Get(0).(func(context.Context, *gen.GetRunningOrgRequest) *gen.GetRunningOrgResponse); ok {
		r0 = rf(_a0, _a1)
	} else {
		if ret.Get(0) != nil {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, *gen.GetRunningOrgRequest) error); ok {
		r1 = rf(_a0, _a1)
	} else {
		r1 = ret.Error(1)
	}
