...
// GetRunningOrg provides a mock function with given fields: ctx, in, opts
func (_m *OrgServiceClient) GetRunningOrg(ctx context.Context, in *gen.GetRunningOrgRequest, opts ...grpc.CallOption) (*gen.GetRunningOrgResponse, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
	...
	var r0 *gen.GetRunningOrgResponse
	if rf, ok := ret.Get(0).(func(context.Context, *gen.GetRunningOrgRequest, ...grpc.CallOption) *gen.GetRunningOrgResponse); ok {
		r0 = rf(ctx, in, opts...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*gen.GetRunningOrgResponse)
		}
	}

	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, *gen.GetRunningOrgRequest, ...grpc.CallOption) error); ok {
		r1 = rf(ctx, in, opts...)
	} else {
		r1 = ret.Error(1)
	}
