...
type mockConstructorTestingTNewSimcardRepo interface {
	mock.TestingT
	Cleanup(func())
}

// NewSimcardRepo creates a new instance of SimcardRepo. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
func NewSimcardRepo(t mockConstructorTestingTNewSimcardRepo) *SimcardRepo {
	mock := &SimcardRepo{}
	mock.Mock.Test(t)
