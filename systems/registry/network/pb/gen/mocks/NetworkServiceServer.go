...
func (_m *NetworkServiceServer) AddSite(_a0 context.Context, _a1 *gen.AddSiteRequest) (*gen.AddSiteResponse, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *gen.AddSiteRequest) (*gen.AddSiteResponse, error)); ok {
		return rf(_a0, _a1)
	}
...
func (_m *NetworkServiceServer) GetSiteByName(_a0 context.Context, _a1 *gen.GetSiteByNameRequest) (*gen.GetSiteResponse, error) {
	...
	var r0 *gen.GetSiteResponse
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *gen.GetSiteByNameRequest) (*gen.GetSiteResponse, error)); ok {
		return rf(_a0, _a1)
	}
...
func (_m *NetworkServiceServer) GetSitesByNetwork(_a0 context.Context, _a1 *gen.GetSitesByNetworkRequest) (*gen.GetSitesByNetworkResponse, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *gen.GetSitesByNetworkRequest) (*gen.GetSitesByNetworkResponse, error)); ok {
		return rf(_a0, _a1)
	}
