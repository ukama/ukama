...
func (_m *OrgClientProvider) GetOrgByName(name string) (*providers.OrgInfo, error) {
	ret := _m.Called(name)
...
func (_m *OrgClientProvider) GetUserById(userId string) (*providers.UserInfo, error) {
