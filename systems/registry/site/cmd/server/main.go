...
func runGrpcServer(gormdb sql.Db) {
	...
	inv := providers.NewInventoryProvider(serviceConfig.InventoryHost, serviceConfig.DebugMode)
	...
	siteServer := server.NewSiteServer(serviceConfig.OrgName, db.NewSiteRepo(gormdb),
		mbClient, providers.NewNetworkClientProvider(serviceConfig.Network),serviceConfig.PushGateway, inv)
