...
// NewNodeServiceServer creates a new instance of NodeServiceServer. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewNodeServiceServer(t testing.TB) *NodeServiceServer {
