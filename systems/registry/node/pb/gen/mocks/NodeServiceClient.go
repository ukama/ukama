...
// GetNodesByState provides a mock function with given fields: ctx, in, opts
func (_m *NodeServiceClient) GetNodesByState(ctx context.Context, in *gen.GetNodesByStateRequest, opts ...grpc.CallOption) (*gen.GetNodesResponse, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
	...
	var r0 *gen.GetNodesResponse
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *gen.GetNodesByStateRequest, ...grpc.CallOption) (*gen.GetNodesResponse, error)); ok {
		return rf(ctx, in, opts...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *gen.GetNodesByStateRequest, ...grpc.CallOption) *gen.GetNodesResponse); ok {
		r0 = rf(ctx, in, opts...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*gen.GetNodesResponse)
	...
	if rf, ok := ret.Get(1).(func(context.Context, *gen.GetNodesByStateRequest, ...grpc.CallOption) error); ok {
		r1 = rf(ctx, in, opts...)
	} else {
		r1 = ret.Error(1)
	}
...
// GetNodesForNetwork provides a mock function with given fields: ctx, in, opts
func (_m *NodeServiceClient) GetNodesForNetwork(ctx context.Context, in *gen.GetByNetworkRequest, opts ...grpc.CallOption) (*gen.GetByNetworkResponse, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
...
func (_m *NodeServiceClient) List(ctx context.Context, in *gen.ListRequest, opts ...grpc.CallOption) (*gen.ListResponse, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
