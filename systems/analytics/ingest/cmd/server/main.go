...
import (
	...
	"github.com/ukama/ukama/systems/analytics/ingest/cmd/version"
	"github.com/ukama/ukama/systems/analytics/ingest/pkg"
	"github.com/ukama/ukama/systems/analytics/ingest/pkg/db"
	"github.com/ukama/ukama/systems/analytics/ingest/pkg/engine"
...
func initDb() sql.Db {
	...
	// Ingest owns migration of its zone plus the shared ledger.
	err := d.Init(&schema.RawRecord{}, &schema.WindowLedger{}, &schema.IngestError{})
	if err != nil {
...
func run(sDb sql.Db) {
	...
	specs, err := schema.LoadSourceSpecs(serviceConfig.Engine.SpecsDir)
	if err != nil {
	...
	res := resolver.New(serviceConfig.Http.InitClient, serviceConfig.Engine.ResolverTTL,
