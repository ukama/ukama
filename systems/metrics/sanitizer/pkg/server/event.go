...
func NewSanitizerEventServer(orgName string, m *collector.MetricsCollector) *SanitizerEventServer {
...
func (s *SanitizerEventServer) EventNotification(ctx context.Context, e *epb.Event) (*epb.EventResponse, error) {
...
func handleEventSimUsage(key string, msg *epb.EventSimUsage, s *SanitizerEventServer) error {
...
func AddSimUsage(msg *epb.EventSimUsage, s *SanitizerEventServer, ms pkg.MetricSchema) error {
...
func AddSimUsageDuration(msg *epb.EventSimUsage, s *SanitizerEventServer, ms pkg.MetricSchema) error {
