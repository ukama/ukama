...
// CreateServiceMsgBusHandler provides a mock function with no fields
func (_m *MsgBusHandlerInterface) CreateServiceMsgBusHandler() error {
	ret := _m.Called()

	if len(ret) == 0 {
		panic("no return value specified for CreateServiceMsgBusHandler")
	}
...
func (_m *MsgBusHandlerInterface) RemoveServiceQueueListening(service string) error {
	...
	if len(ret) == 0 {
		panic("no return value specified for RemoveServiceQueueListening")
	}
...
func (_m *MsgBusHandlerInterface) RemoveServiceQueuePublisher(service string) error {
	...
	if len(ret) == 0 {
		panic("no return value specified for RemoveServiceQueuePublisher")
	}
...
func (_m *MsgBusHandlerInterface) StopServiceQueueHandler(service string) error {
	...
	if len(ret) == 0 {
		panic("no return value specified for StopServiceQueueHandler")
	}
...
func (_m *MsgBusHandlerInterface) UpdateServiceQueueHandler(s *db.Service) error {
	...
	if len(ret) == 0 {
		panic("no return value specified for UpdateServiceQueueHandler")
	}
