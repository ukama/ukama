module github.com/ukama/ukama/systems/messaging/net
...
replace github.com/ukama/ukama/systems/messaging/net => ./

replace github.com/ukama/ukama/systems/messaging/net/mocks => ./mocks
