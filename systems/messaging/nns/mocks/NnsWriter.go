...
type mockConstructorTestingTNewNnsWriter interface {
	mock.TestingT
	Cleanup(func())
}

// NewNnsWriter creates a new instance of NnsWriter. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
func NewNnsWriter(t mockConstructorTestingTNewNnsWriter) *NnsWriter {
	mock := &NnsWriter{}
	mock.Mock.Test(t)
