...
type mockConstructorTestingTNewSimPoolServer interface {
	mock.TestingT
	Cleanup(func())
}

// NewSimPoolServer creates a new instance of SimPoolServer. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
func NewSimPoolServer(t mockConstructorTestingTNewSimPoolServer) *SimPoolServer {
	mock := &SimPoolServer{}
	mock.Mock.Test(t)
