...
type mockConstructorTestingTNewImsiClientProvider interface {
	mock.TestingT
	Cleanup(func())
}

// NewImsiClientProvider creates a new instance of ImsiClientProvider. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
func NewImsiClientProvider(t mockConstructorTestingTNewImsiClientProvider) *ImsiClientProvider {
