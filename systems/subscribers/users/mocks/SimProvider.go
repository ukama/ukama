...
type mockConstructorTestingTNewSimProvider interface {
	mock.TestingT
	Cleanup(func())
}

// NewSimProvider creates a new instance of SimProvider. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
func NewSimProvider(t mockConstructorTestingTNewSimProvider) *SimProvider {
	mock := &SimProvider{}
	mock.Mock.Test(t)
