...
type mockConstructorTestingTNewImsiServiceClient interface {
	mock.TestingT
	Cleanup(func())
}

// NewImsiServiceClient creates a new instance of ImsiServiceClient. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
func NewImsiServiceClient(t mockConstructorTestingTNewImsiServiceClient) *ImsiServiceClient {
	mock := &ImsiServiceClient{}
	mock.Mock.Test(t)
