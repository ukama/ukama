...
func (UnimplementedSoftwareServiceServer) GetSoftwareList(context.Context, *GetSoftwareListRequest) (*GetSoftwareListResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetSoftwareList not implemented")
}
func (UnimplementedSoftwareServiceServer) UpdateSoftware(context.Context, *UpdateSoftwareRequest) (*UpdateSoftwareResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method UpdateSoftware not implemented")
}
...
func RegisterSoftwareServiceServer(s grpc.ServiceRegistrar, srv SoftwareServiceServer) {
	// If the following call panics, it indicates UnimplementedSoftwareServiceServer was
