...
type mockConstructorTestingTNewControllerServiceServer interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewControllerServiceServer(t mockConstructorTestingTNewControllerServiceServer) *ControllerServiceServer {
