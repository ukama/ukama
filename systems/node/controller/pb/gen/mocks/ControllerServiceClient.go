...
type mockConstructorTestingTNewControllerServiceClient interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewControllerServiceClient(t mockConstructorTestingTNewControllerServiceClient) *ControllerServiceClient {
