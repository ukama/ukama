...
func (_m *HealthRepo) GetRunningAppsInfo(nodeId uuid.UUID) (*db.Health, error) {
	ret := _m.Called(nodeId)

	var r0 *db.Health
	var r1 error
	if rf, ok := ret.Get(0).(func(uuid.UUID) (*db.Health, error)); ok {
		return rf(nodeId)
	}
	if rf, ok := ret.Get(0).(func(uuid.UUID) *db.Health); ok {
		r0 = rf(nodeId)
	} else {
		if ret.Get(0) != nil {
