...
// GetRunningAppsInfo provides a mock function with given fields:
func (_m *HealthRepo) GetRunningAppsInfo() ([]*db.Health, error) {
	ret := _m.Called()

	var r0 []*db.Health
	var r1 error
	if rf, ok := ret.Get(0).(func() ([]*db.Health, error)); ok {
		return rf()
	}
	if rf, ok := ret.Get(0).(func() []*db.Health); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
