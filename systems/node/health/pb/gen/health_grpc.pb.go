...
const (
	HealhtService_ListApps_FullMethodName             = "/ukama.node.health.v1.healhtService/ListApps"
...
func (c *healhtServiceClient) ListApps(ctx context.Context, in *ListAppsRequest, opts ...grpc.CallOption) (*ListAppsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ListAppsResponse)
	err := c.cc.Invoke(ctx, HealhtService_ListApps_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *healhtServiceClient) List(ctx context.Context, in *ListRequest, opts ...grpc.CallOption) (*ListResponse, error) {
	...
	err := c.cc.Invoke(ctx, HealhtService_List_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *healhtServiceClient) StoreRunningAppsInfo(ctx context.Context, in *StoreRunningAppsInfoRequest, opts ...grpc.CallOption) (*StoreRunningAppsInfoResponse, error) {
	...
	err := c.cc.Invoke(ctx, HealhtService_StoreRunningAppsInfo_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedHealhtServiceServer must be embedded to have
...
func (UnimplementedHealhtServiceServer) ListApps(context.Context, *ListAppsRequest) (*ListAppsResponse, error) {
...
func (UnimplementedHealhtServiceServer) testEmbeddedByValue()                       {}
...
func RegisterHealhtServiceServer(s grpc.ServiceRegistrar, srv HealhtServiceServer) {
	// If the following call pancis, it indicates UnimplementedHealhtServiceServer was
...
func _HealhtService_ListApps_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListAppsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(HealhtServiceServer).ListApps(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: HealhtService_ListApps_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HealhtServiceServer).ListApps(ctx, req.(*ListAppsRequest))
	}
...
func _HealhtService_List_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	if interceptor == nil {
		return srv.(HealhtServiceServer).List(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: HealhtService_List_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HealhtServiceServer).List(ctx, req.(*ListRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var HealhtService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "ListApps",
			Handler:    _HealhtService_ListApps_Handler,
		},
		{
			MethodName: "List",
