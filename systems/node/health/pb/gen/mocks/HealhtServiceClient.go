...
func (_m *HealhtServiceClient) GetApps(ctx context.Context, in *gen.GetAppsRequest, opts ...grpc.CallOption) (*gen.GetAppsResponse, error) {
...
func (_m *HealhtServiceClient) List(ctx context.Context, in *gen.ListRequest, opts ...grpc.CallOption) (*gen.ListResponse, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
