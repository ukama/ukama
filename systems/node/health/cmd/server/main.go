...
import (
	...
	"github.com/ukama/ukama/systems/node/health/cmd/version"
...
func runGrpcServer(gormdb sql.Db) {
	...
	regServer := server.NewHealthServer(svcConf.OrgName, db.NewHealthRepo(gormdb), svcConf.DebugMode, mbClient)
