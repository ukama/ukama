...
func (s *SiteController) SetSite(ctx context.Context, siteID, state, reason, requestedBy string) (*pb.SetSiteResponse, error) {
...
func (s *SiteController) SetService(ctx context.Context, siteID, state string) (*pb.SetServiceResponse, error) {
	ctx, cancel := context.WithTimeout(context.WithoutCancel(ctx), s.timeout)
	defer cancel()
	return s.client.SetService(ctx, &pb.SetServiceRequest{SiteId: siteID, State: state})
}

func (s *SiteController) SetRadio(ctx context.Context, siteID, state string) (*pb.SetRadioResponse, error) {
	ctx, cancel := context.WithTimeout(context.WithoutCancel(ctx), s.timeout)
	defer cancel()
	return s.client.SetRadio(ctx, &pb.SetRadioRequest{SiteId: siteID, State: state})
}

func (s *SiteController) GetSiteState(ctx context.Context, siteID string) (*pb.GetSiteStateResponse, error) {
	ctx, cancel := context.WithTimeout(context.WithoutCancel(ctx), s.timeout)
	defer cancel()
	return s.client.GetSiteState(ctx, &pb.GetSiteStateRequest{SiteId: siteID})
}

func (s *SiteController) UpsertPortMap(ctx context.Context, siteID, cnodeID string, ports []*pb.PortMapEntry) (*pb.UpsertPortMapResponse, error) {
	ctx, cancel := context.WithTimeout(context.WithoutCancel(ctx), s.timeout)
	defer cancel()
	return s.client.UpsertPortMap(ctx, &pb.UpsertPortMapRequest{SiteId: siteID, CnodeId: cnodeID, Ports: ports})
}

func (s *SiteController) GetPortMap(ctx context.Context, siteID string) (*pb.GetPortMapResponse, error) {
	ctx, cancel := context.WithTimeout(context.WithoutCancel(ctx), s.timeout)
	defer cancel()
	return s.client.GetPortMap(ctx, &pb.GetPortMapRequest{SiteId: siteID})
}

func (s *SiteController) ApplySwitchPolicy(ctx context.Context, siteID string) (*pb.ApplySwitchPolicyResponse, error) {
	ctx, cancel := context.WithTimeout(context.WithoutCancel(ctx), s.timeout)
	defer cancel()
	return s.client.ApplySwitchPolicy(ctx, &pb.ApplySwitchPolicyRequest{SiteId: siteID})
}

func (s *SiteController) PowerCycleNode(ctx context.Context, siteID, role, reason, requestedBy string) (*pb.PowerCycleNodeResponse, error) {
	ctx, cancel := context.WithTimeout(context.WithoutCancel(ctx), s.timeout)
	defer cancel()
...
func (s *SiteController) RestartSite(ctx context.Context, siteID string) (*pb.RestartSiteResponse, error) {
	ctx, cancel := context.WithTimeout(context.WithoutCancel(ctx), s.timeout)
	defer cancel()
	return s.client.RestartSite(ctx, &pb.RestartSiteRequest{SiteId: siteID})
}

func (s *SiteController) ToggleInternetSwitch(ctx context.Context, siteID string, status bool, port int32) (*pb.ToggleInternetSwitchResponse, error) {
	ctx, cancel := context.WithTimeout(context.WithoutCancel(ctx), s.timeout)
	defer cancel()
