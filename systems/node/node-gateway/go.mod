module github.com/ukama/ukama/systems/node/node-gateway
...
replace github.com/ukama/ukama/systems/node/notify => ../notify

replace github.com/ukama/ukama/systems/node/node-gateway => ./
