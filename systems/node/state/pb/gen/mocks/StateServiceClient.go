...
// RecordConfiguration provides a mock function with given fields: ctx, in, opts
func (_m *StateServiceClient) RecordConfiguration(ctx context.Context, in *gen.RecordConfigurationRequest, opts ...grpc.CallOption) (*gen.ConfigurationStatus, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *gen.RecordConfigurationRequest, ...grpc.CallOption) (*gen.ConfigurationStatus, error)); ok {
		return rf(ctx, in, opts...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *gen.RecordConfigurationRequest, ...grpc.CallOption) *gen.ConfigurationStatus); ok {
		r0 = rf(ctx, in, opts...)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(context.Context, *gen.RecordConfigurationRequest, ...grpc.CallOption) error); ok {
		r1 = rf(ctx, in, opts...)
	} else {
		r1 = ret.Error(1)
	}
...
// GetStatesHistory provides a mock function with given fields: ctx, in, opts
func (_m *StateServiceClient) GetStatesHistory(ctx context.Context, in *gen.GetStatesHistoryRequest, opts ...grpc.CallOption) (*gen.GetStatesHistoryResponse, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *gen.GetStatesHistoryRequest, ...grpc.CallOption) (*gen.GetStatesHistoryResponse, error)); ok {
		return rf(ctx, in, opts...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *gen.GetStatesHistoryRequest, ...grpc.CallOption) *gen.GetStatesHistoryResponse); ok {
		r0 = rf(ctx, in, opts...)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(context.Context, *gen.GetStatesHistoryRequest, ...grpc.CallOption) error); ok {
		r1 = rf(ctx, in, opts...)
	} else {
		r1 = ret.Error(1)
	}
...
// UpdateState provides a mock function with given fields: ctx, in, opts
func (_m *StateServiceClient) UpdateState(ctx context.Context, in *gen.UpdateStateRequest, opts ...grpc.CallOption) (*gen.UpdateStateResponse, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
