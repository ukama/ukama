...
const (
	StateService_RecordConfiguration_FullMethodName    = "/ukama.node.state.v1.StateService/RecordConfiguration"
...
type StateServiceClient interface {
	// Internal bookkeeping: record the command identity before controller dispatch.
	RecordConfiguration(ctx context.Context, in *RecordConfigurationRequest, opts ...grpc.CallOption) (*ConfigurationStatus, error)
...
func (c *stateServiceClient) RecordConfiguration(ctx context.Context, in *RecordConfigurationRequest, opts ...grpc.CallOption) (*ConfigurationStatus, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ConfigurationStatus)
	err := c.cc.Invoke(ctx, StateService_RecordConfiguration_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *stateServiceClient) GetStatesHistory(ctx context.Context, in *GetStatesHistoryRequest, opts ...grpc.CallOption) (*GetStatesHistoryResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetStatesHistoryResponse)
	err := c.cc.Invoke(ctx, StateService_GetStatesHistory_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type StateServiceServer interface {
	// Internal bookkeeping: record the command identity before controller dispatch.
	RecordConfiguration(context.Context, *RecordConfigurationRequest) (*ConfigurationStatus, error)
...
func (UnimplementedStateServiceServer) RecordConfiguration(context.Context, *RecordConfigurationRequest) (*ConfigurationStatus, error) {
	return nil, status.Errorf(codes.Unimplemented, "method RecordConfiguration not implemented")
}
...
func _StateService_RecordConfiguration_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RecordConfigurationRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(StateServiceServer).RecordConfiguration(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: StateService_RecordConfiguration_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(StateServiceServer).RecordConfiguration(ctx, req.(*RecordConfigurationRequest))
	}
...
func _StateService_GetStatesHistory_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetStatesHistoryRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(StateServiceServer).GetStatesHistory(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: StateService_GetStatesHistory_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(StateServiceServer).GetStatesHistory(ctx, req.(*GetStatesHistoryRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var StateService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "RecordConfiguration",
			Handler:    _StateService_RecordConfiguration_Handler,
		},
		{
			MethodName: "AddState",
