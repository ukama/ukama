...
func (_m *MarkupsRepo) CreateMarkupRate(_a0 uuid.UUID, markup float64) error {
	...
	if len(ret) == 0 {
		panic("no return value specified for CreateMarkupRate")
	}
...
func (_m *MarkupsRepo) DeleteMarkupRate(_a0 uuid.UUID) error {
	...
	if len(ret) == 0 {
		panic("no return value specified for DeleteMarkupRate")
	}
...
func (_m *MarkupsRepo) GetMarkupRate(_a0 uuid.UUID) (*db.Markups, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for GetMarkupRate")
	}
...
func (_m *MarkupsRepo) GetMarkupRateHistory(_a0 uuid.UUID) ([]db.Markups, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for GetMarkupRateHistory")
	}
...
func (_m *MarkupsRepo) UpdateMarkupRate(_a0 uuid.UUID, markup float64) error {
	...
	if len(ret) == 0 {
		panic("no return value specified for UpdateMarkupRate")
	}
...
func NewMarkupsRepo(t interface {
	mock.TestingT
	Cleanup(func())
}) *MarkupsRepo {
	mock := &MarkupsRepo{}
