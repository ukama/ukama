...
import (
	...
	pbgen "github.com/ukama/ukama/systems/data-plan/base-rate/pb/gen"
)
...
func (_m *dataPlan) DeletePackage(id string) (*gen.DeletePackageResponse, error) {
	ret := _m.Called(id)
...
func (_m *dataPlan) GetBaseRate(id string) (*pbgen.GetBaseRateResponse, error) {
	ret := _m.Called(id)

	var r0 *pbgen.GetBaseRateResponse
	if rf, ok := ret.Get(0).(func(string) *pbgen.GetBaseRateResponse); ok {
		r0 = rf(id)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*pbgen.GetBaseRateResponse)
		}
	}
...
func (_m *dataPlan) GetBaseRates(req *pbgen.GetBaseRatesRequest) (*pbgen.GetBaseRatesResponse, error) {
	ret := _m.Called(req)

	var r0 *pbgen.GetBaseRatesResponse
	if rf, ok := ret.Get(0).(func(*pbgen.GetBaseRatesRequest) *pbgen.GetBaseRatesResponse); ok {
		r0 = rf(req)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*pbgen.GetBaseRatesResponse)
		}
	}

	var r1 error
	if rf, ok := ret.Get(1).(func(*pbgen.GetBaseRatesRequest) error); ok {
		r1 = rf(req)
	} else {
		r1 = ret.Error(1)
	}
...
func (_m *dataPlan) GetPackage(id string) (*gen.GetPackageResponse, error) {
	ret := _m.Called(id)
...
func (_m *dataPlan) GetPackageByOrg(orgId string) (*gen.GetByOrgPackageResponse, error) {
	ret := _m.Called(orgId)
...
func (_m *dataPlan) UploadBaseRates(req *pbgen.UploadBaseRatesRequest) (*pbgen.UploadBaseRatesResponse, error) {
	ret := _m.Called(req)

	var r0 *pbgen.UploadBaseRatesResponse
	if rf, ok := ret.Get(0).(func(*pbgen.UploadBaseRatesRequest) *pbgen.UploadBaseRatesResponse); ok {
		r0 = rf(req)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*pbgen.UploadBaseRatesResponse)
		}
	}

	var r1 error
	if rf, ok := ret.Get(1).(func(*pbgen.UploadBaseRatesRequest) error); ok {
		r1 = rf(req)
	} else {
		r1 = ret.Error(1)
	}
