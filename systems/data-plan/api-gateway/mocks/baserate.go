...
// GetBaseRatesById provides a mock function with given fields: h, req
func (_m *baserate) GetBaseRatesById(h http.Header, req *gen.GetBaseRatesByIdRequest) (*gen.GetBaseRatesByIdResponse, error) {
	ret := _m.Called(h, req)

	var r0 *gen.GetBaseRatesByIdResponse
	var r1 error
	if rf, ok := ret.Get(0).(func(http.Header, *gen.GetBaseRatesByIdRequest) (*gen.GetBaseRatesByIdResponse, error)); ok {
		return rf(h, req)
	}
	if rf, ok := ret.Get(0).(func(http.Header, *gen.GetBaseRatesByIdRequest) *gen.GetBaseRatesByIdResponse); ok {
		r0 = rf(h, req)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(http.Header, *gen.GetBaseRatesByIdRequest) error); ok {
		r1 = rf(h, req)
	} else {
		r1 = ret.Error(1)
	}
