...
func (_m *BaseRateRepo) GetBaseRate(_a0 uuid.UUID) (*db.Rate, error) {
	...
	var r0 *db.Rate
	var r1 error
	if rf, ok := ret.Get(0).(func(uuid.UUID) (*db.Rate, error)); ok {
		return rf(_a0)
	}
...
func (_m *BaseRateRepo) GetBaseRates(country string, network string, effectiveAt string, simType db.SimType) ([]db.Rate, error) {
	...
	var r0 []db.Rate
	var r1 error
	if rf, ok := ret.Get(0).(func(string, string, string, db.SimType) ([]db.Rate, error)); ok {
		return rf(country, network, effectiveAt, simType)
	}
