...
// GetBaseRates provides a mock function with given fields: country, provider, simType
func (_m *BaseRateRepo) GetBaseRates(country string, provider string, simType ukama.SimType) ([]db.BaseRate, error) {
