...
func (c *packagesServiceClient) GetAll(ctx context.Context, in *GetAllRequest, opts ...grpc.CallOption) (*GetAllResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/ukama.data_plan.package.v1.PackagesService/GetAll", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *packagesServiceClient) IsNameAvailable(ctx context.Context, in *IsNameAvailableRequest, opts ...grpc.CallOption) (*IsNameAvailableResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/ukama.data_plan.package.v1.PackagesService/IsNameAvailable", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _PackagesService_GetAll_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ukama.data_plan.package.v1.PackagesService/GetAll",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _PackagesService_IsNameAvailable_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ukama.data_plan.package.v1.PackagesService/IsNameAvailable",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
