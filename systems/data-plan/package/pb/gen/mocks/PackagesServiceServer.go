...
func (_m *PackagesServiceServer) AddPackage(_a0 context.Context, _a1 *pb.AddPackageRequest) (*pb.AddPackageResponse, error) {
	...
	if rf, ok := ret.Get(0).(func(context.Context, *pb.AddPackageRequest) *pb.AddPackageResponse); ok {
		r0 = rf(_a0, _a1)
	} else {
		if ret.Get(0) != nil {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, *pb.AddPackageRequest) error); ok {
		r1 = rf(_a0, _a1)
	} else {
		r1 = ret.Error(1)
	}
