...
func (_m *PackagesServiceClient) CreatePackage(ctx context.Context, in *pb.CreatePackageRequest, opts ...grpc.CallOption) (*pb.CreatePackageResponse, error) {
	...
	if rf, ok := ret.Get(0).(func(context.Context, *pb.CreatePackageRequest, ...grpc.CallOption) *pb.CreatePackageResponse); ok {
		r0 = rf(ctx, in, opts...)
	} else {
		if ret.Get(0) != nil {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, *pb.CreatePackageRequest, ...grpc.CallOption) error); ok {
		r1 = rf(ctx, in, opts...)
	} else {
		r1 = ret.Error(1)
	}
...
// GetPackage provides a mock function with given fields: ctx, in, opts
func (_m *PackagesServiceClient) GetPackage(ctx context.Context, in *pb.GetPackageRequest, opts ...grpc.CallOption) (*pb.GetPackageResponse, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
	...
	if rf, ok := ret.Get(0).(func(context.Context, *pb.GetPackageRequest, ...grpc.CallOption) *pb.GetPackageResponse); ok {
		r0 = rf(ctx, in, opts...)
	} else {
		if ret.Get(0) != nil {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, *pb.GetPackageRequest, ...grpc.CallOption) error); ok {
		r1 = rf(ctx, in, opts...)
	} else {
		r1 = ret.Error(1)
	}
