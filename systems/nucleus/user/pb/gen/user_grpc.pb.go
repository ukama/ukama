...
const (
	UserService_Add_FullMethodName         = "/ukama.nuclues.user.v1.UserService/Add"
	UserService_Get_FullMethodName         = "/ukama.nuclues.user.v1.UserService/Get"
	UserService_GetByAuthId_FullMethodName = "/ukama.nuclues.user.v1.UserService/GetByAuthId"
	UserService_Update_FullMethodName      = "/ukama.nuclues.user.v1.UserService/Update"
	UserService_Deactivate_FullMethodName  = "/ukama.nuclues.user.v1.UserService/Deactivate"
	UserService_Delete_FullMethodName      = "/ukama.nuclues.user.v1.UserService/Delete"
	UserService_Whoami_FullMethodName      = "/ukama.nuclues.user.v1.UserService/Whoami"
	UserService_GetByEmail_FullMethodName  = "/ukama.nuclues.user.v1.UserService/GetByEmail"
)
...
func (c *userServiceClient) GetByAuthId(ctx context.Context, in *GetByAuthIdRequest, opts ...grpc.CallOption) (*GetResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetResponse)
	err := c.cc.Invoke(ctx, UserService_GetByAuthId_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userServiceClient) Deactivate(ctx context.Context, in *DeactivateRequest, opts ...grpc.CallOption) (*DeactivateResponse, error) {
	...
	err := c.cc.Invoke(ctx, UserService_Deactivate_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
