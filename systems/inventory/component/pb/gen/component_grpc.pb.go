...
func (c *componentServiceClient) Get(ctx context.Context, in *GetRequest, opts ...grpc.CallOption) (*GetResponse, error) {
	out := new(GetResponse)
	err := c.cc.Invoke(ctx, ComponentService_Get_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *componentServiceClient) GetByUser(ctx context.Context, in *GetByUserRequest, opts ...grpc.CallOption) (*GetByUserResponse, error) {
	...
	err := c.cc.Invoke(ctx, ComponentService_GetByUser_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *componentServiceClient) SyncComponents(ctx context.Context, in *SyncComponentsRequest, opts ...grpc.CallOption) (*SyncComponentsResponse, error) {
	...
	err := c.cc.Invoke(ctx, ComponentService_SyncComponents_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
