...
func (_m *Report) Add(rawReport string) (*gen.AddResponse, error) {
...
// Get provides a mock function with given fields: reportId, asPDF
func (_m *Report) Get(reportId string, asPDF bool) (*gen.GetResponse, error) {
	ret := _m.Called(reportId, asPDF)
