...
func (_m *ReportRepo) List(ownerId string, ownerType db.OwnerType, networkId string, reportType db.ReportType, isPaid bool, count uint32, sort bool) ([]db.Report, error) {
	...
	var r0 []db.Report
	var r1 error
	if rf, ok := ret.Get(0).(func(string, db.OwnerType, string, db.ReportType, bool, uint32, bool) ([]db.Report, error)); ok {
		return rf(ownerId, ownerType, networkId, reportType, isPaid, count, sort)
	}
	if rf, ok := ret.Get(0).(func(string, db.OwnerType, string, db.ReportType, bool, uint32, bool) []db.Report); ok {
	...
	if rf, ok := ret.Get(1).(func(string, db.OwnerType, string, db.ReportType, bool, uint32, bool) error); ok {
