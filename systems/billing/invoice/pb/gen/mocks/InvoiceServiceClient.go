...
func (_m *InvoiceServiceClient) List(ctx context.Context, in *gen.ListRequest, opts ...grpc.CallOption) (*gen.ListResponse, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
...
func NewInvoiceServiceClient(t interface {
	mock.TestingT
	Cleanup(func())
