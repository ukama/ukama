...
func (UnimplementedArtifactServiceServer) GetArtifactLocation(context.Context, *GetArtifactLocationRequest) (*GetArtifactLocationResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetArtifactLocation not implemented")
}
...
func (UnimplementedArtifactServiceServer) GetArtifactVersionList(context.Context, *GetArtifactVersionListRequest) (*GetArtifactVersionListResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetArtifactVersionList not implemented")
}
