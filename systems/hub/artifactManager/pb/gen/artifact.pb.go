...
const file_artifact_proto_rawDesc = "" +
	...
	"\bVersions\x18\x04 \x03(\v2).ukama.hub.artifactmanager.v1.VersionInfoR\bversions\"v\n" +
	"\x13ListArtifactRequest\x12G\n" +
	"\x04Type\x18\x01 \x01(\x0e2*.ukama.hub.artifactmanager.v1.ArtifactTypeB\a\xe2\xdf\x1f\x03\x88\x01\x01R\x04type\x12\x16\n" +
	"\x06Latest\x18\x02 \x01(\bR\x06latest\"g\n" +
	"\x0eLatestArtifact\x12\x12\n" +
	"\x04Name\x18\x01 \x01(\tR\x04name\x12A\n" +
	"\x06Latest\x18\x02 \x01(\v2).ukama.hub.artifactmanager.v1.VersionInfoR\x06latest\"\x8b\x01\n" +
	"\x14ListArtifactResponse\x12\x1a\n" +
	"\bartifact\x18\x01 \x03(\tR\bartifact\x12W\n" +
	"\x0fLatestArtifacts\x18\x02 \x03(\v2,.ukama.hub.artifactmanager.v1.LatestArtifactR\x10latest_artifacts*7\n" +
