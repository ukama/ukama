...
import (
	...
	pkg "github.com/ukama/ukama/systems/hub/distributor/pkg"
)
...
// SetConfig provides a mock function with given fields: c, s
func (_m *chunker) SetConfig(c *pkg.ChunkConfig, s *pkg.StoreConfig) {
	_m.Called(c, s)
}

type mockConstructorTestingTnewChunker interface {
	mock.TestingT
	Cleanup(func())
}
...
func newChunker(t mockConstructorTestingTnewChunker) *chunker {
	mock := &chunker{}
	mock.Mock.Test(t)
