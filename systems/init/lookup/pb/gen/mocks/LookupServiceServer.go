...
// EventListner provides a mock function with given fields: _a0, _a1
func (_m *LookupServiceServer) EventListner(_a0 context.Context, _a1 *gen.Event) (*gen.EventResponse, error) {
	ret := _m.Called(_a0, _a1)
