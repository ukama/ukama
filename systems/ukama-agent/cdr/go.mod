module github.com/ukama/ukama/systems/ukama-agent/cdr
...
require github.com/num30/config v0.1.3
...
replace github.com/ukama/ukama/systems/ukama-agent/cdr => ./

replace github.com/ukama/ukama/systems/ukama-agent/cdr/mocks => ./mocks
