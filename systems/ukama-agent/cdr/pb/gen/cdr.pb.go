...
type UsageForPackageReq struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *UsageForPackageReq) Reset() {
	*x = UsageForPackageReq{}
	if protoimpl.UnsafeEnabled {
...
func (x *UsageForPackageReq) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*UsageForPackageReq) ProtoMessage() {}

func (x *UsageForPackageReq) ProtoReflect() protoreflect.Message {
	mi := &file_cdr_proto_msgTypes[8]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use UsageForPackageReq.ProtoReflect.Descriptor instead.
func (*UsageForPackageReq) Descriptor() ([]byte, []int) {
	return file_cdr_proto_rawDescGZIP(), []int{8}
}

func (x *UsageForPackageReq) GetImsi() string {
	if x != nil {
		return x.Imsi
	}
	return ""
...
func (x *UsageForPackageReq) GetStartTime() uint64 {
	if x != nil {
		return x.StartTime
	}
	return 0
...
func (x *UsageForPackageReq) GetEndTime() uint64 {
	if x != nil {
		return x.EndTime
	}
	return 0
...
type UsageForPackageResp struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *UsageForPackageResp) Reset() {
	*x = UsageForPackageResp{}
	if protoimpl.UnsafeEnabled {
...
func (x *UsageForPackageResp) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*UsageForPackageResp) ProtoMessage() {}

func (x *UsageForPackageResp) ProtoReflect() protoreflect.Message {
	mi := &file_cdr_proto_msgTypes[9]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use UsageForPackageResp.ProtoReflect.Descriptor instead.
func (*UsageForPackageResp) Descriptor() ([]byte, []int) {
	return file_cdr_proto_rawDescGZIP(), []int{9}
}

func (x *UsageForPackageResp) GetUsage() uint64 {
	if x != nil {
		return x.Usage
	}
	return 0
...
var file_cdr_proto_rawDesc = []byte{
	...
	,
...
var file_cdr_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
var file_cdr_proto_goTypes = []interface{}{
	...
	(*UsageForPackageReq)(nil),  // 8: ukama.ukamaagent.cdr.v1.UsageForPackageReq
	(*UsageForPackageResp)(nil), // 9: ukama.ukamaagent.cdr.v1.UsageForPackageResp
}
var file_cdr_proto_depIdxs = []int32{
	...
	8, // 4: ukama.ukamaagent.cdr.v1.CDRService.GetUsageForPackage:input_type -> ukama.ukamaagent.cdr.v1.UsageForPackageReq
	6, // 5: ukama.ukamaagent.cdr.v1.CDRService.GetUsageDetails:input_type -> ukama.ukamaagent.cdr.v1.CycleUsageReq
	1, // 6: ukama.ukamaagent.cdr.v1.CDRService.PostCDR:output_type -> ukama.ukamaagent.cdr.v1.CDRResp
	3, // 7: ukama.ukamaagent.cdr.v1.CDRService.GetCDR:output_type -> ukama.ukamaagent.cdr.v1.RecordResp
	5, // 8: ukama.ukamaagent.cdr.v1.CDRService.GetUsage:output_type -> ukama.ukamaagent.cdr.v1.UsageResp
	9, // 9: ukama.ukamaagent.cdr.v1.CDRService.GetUsageForPackage:output_type -> ukama.ukamaagent.cdr.v1.UsageForPackageResp
	7, // 10: ukama.ukamaagent.cdr.v1.CDRService.GetUsageDetails:output_type -> ukama.ukamaagent.cdr.v1.CycleUsageResp
...
func file_cdr_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_cdr_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*UsageForPackageReq); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_cdr_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*UsageForPackageResp); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
