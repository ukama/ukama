...
func (_m *ProfileServiceClient) Add(ctx context.Context, in *gen.AddReq, opts ...grpc.CallOption) (*gen.AddResp, error) {
	...
	var r0 *gen.AddResp
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *gen.AddReq, ...grpc.CallOption) (*gen.AddResp, error)); ok {
...
func (_m *ProfileServiceClient) Remove(ctx context.Context, in *gen.RemoveReq, opts ...grpc.CallOption) (*gen.RemoveResp, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *gen.RemoveReq, ...grpc.CallOption) (*gen.RemoveResp, error)); ok {
		return rf(ctx, in, opts...)
	}
...
func (_m *ProfileServiceClient) Sync(ctx context.Context, in *gen.SyncReq, opts ...grpc.CallOption) (*gen.SyncResp, error) {
	...
	var r0 *gen.SyncResp
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *gen.SyncReq, ...grpc.CallOption) (*gen.SyncResp, error)); ok {
		return rf(ctx, in, opts...)
	}
...
// UpdateUsage provides a mock function with given fields: ctx, in, opts
func (_m *ProfileServiceClient) UpdateUsage(ctx context.Context, in *gen.UpdateUsageReq, opts ...grpc.CallOption) (*gen.UpdateUsageResp, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *gen.UpdateUsageReq, ...grpc.CallOption) (*gen.UpdateUsageResp, error)); ok {
		return rf(ctx, in, opts...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *gen.UpdateUsageReq, ...grpc.CallOption) *gen.UpdateUsageResp); ok {
		r0 = rf(ctx, in, opts...)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(context.Context, *gen.UpdateUsageReq, ...grpc.CallOption) error); ok {
		r1 = rf(ctx, in, opts...)
	} else {
		r1 = ret.Error(1)
	}
