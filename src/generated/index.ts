...
export type Query = {
    ...
    getMetricsTemperatureCOM: Array<MetricDto>;
    getMetricsTemperatureTRX: Array<MetricDto>;
...
export type QueryGetMetricsTemperatureComArgs = {
    data: MetricsInputDto;
};

export type QueryGetMetricsTemperatureTrxArgs = {
    data: MetricsInputDto;
};
