...
const DrvDBFxnTable drvr_adt7841_fxn_table = {
    .init = drvr_adt7841_init,
    .configure = drvr_adt7841_configure,
    .read = drvr_adt7841_read,
    .write = drvr_adt7841_write,
    .enable = drvr_adt7841_enable,
    .disable = drvr_adt7841_disable,
    .register_cb = drvr_adt7841_reg_cb,
    .dregister_cb = drvr_adt7841_dreg_cb,
    .enable_irq = drvr_adt7841_enable_irq,
    .disable_irq = drvr_adt7841_disable_irq
};
...
int adt7481_confirm_irq(Device *p_dev, AlertCallBackData **acbdata, char *fpath,
                        int *evt) {
    int ret = 0;
    const DrvDBFxnTable *drvr = get_fxn_tbl(p_dev);
    if (drvr) {
