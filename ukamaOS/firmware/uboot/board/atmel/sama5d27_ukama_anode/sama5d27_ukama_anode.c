...
#define ROOT_PARTITION_OFFSET   0x00

#ifdef CONFIG_MISC_INIT_R
int misc_init_r(void)
{
	printf("AN::Misc init for Amplifire node.\n");
#ifdef CONFIG_I2C_EEPROM
	printf("AN::MAC setting.\n");
	at91_set_ethaddr(MAC24AA_MAC_OFFSET);
#ifdef CONFIG_SYS_DUAL_ROOT_PARTITION
	printf("AN::Dual boot setting.\n");
 	at91_set_rootpartition(ROOT_PARTITION_OFFSET);
#endif
#endif
	return 0;
}
...
{
	atmel_pio4_set_pio_output(AT91_PIO_PORTB, 1, 1); /* GREEN1 */
	atmel_pio4_set_pio_output(AT91_PIO_PORTA, 31, 1); /* RED1 */
	atmel_pio4_set_pio_output(AT91_PIO_PORTA, 10, 1); /* GREEN2 */
	atmel_pio4_set_pio_output(AT91_PIO_PORTA, 11, 1); /* RED2 */ 
	atmel_pio4_set_pio_output(AT91_PIO_PORTA, 13, 1); /* GREEN3 */
	atmel_pio4_set_pio_output(AT91_PIO_PORTA, 14, 1); /* RED3 */ 
	atmel_pio4_set_pio_output(AT91_PIO_PORTA, 16, 1); /* GREEN4 */
	atmel_pio4_set_pio_output(AT91_PIO_PORTA, 17, 1); /* RED4 */
}
