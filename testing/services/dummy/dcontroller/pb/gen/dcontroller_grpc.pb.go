...
func (UnimplementedMetricsControllerServer) GetSiteMetrics(context.Context, *GetSiteMetricsRequest) (*GetSiteMetricsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetSiteMetrics not implemented")
}
func (UnimplementedMetricsControllerServer) StartMetrics(context.Context, *StartMetricsRequest) (*StartMetricsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method StartMetrics not implemented")
}
func (UnimplementedMetricsControllerServer) StopMetrics(context.Context, *StopMetricsRequest) (*StopMetricsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method StopMetrics not implemented")
}
...
func (UnimplementedMetricsControllerServer) UpdatePortStatus(context.Context, *UpdatePortStatusRequest) (*UpdatePortStatusResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method UpdatePortStatus not implemented")
}
...
func RegisterMetricsControllerServer(s grpc.ServiceRegistrar, srv MetricsControllerServer) {
	// If the following call panics, it indicates UnimplementedMetricsControllerServer was
