...
func (_m *WebhooksClient) PostDepositHook(_a0 *util.Deposit) (*clients.WebhookInfo, error) {
	ret := _m.Called(_a0)
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(*util.Deposit) (*clients.WebhookInfo, error)); ok {
		return rf(_a0)
	}
	if rf, ok := ret.Get(0).(func(*util.Deposit) *clients.WebhookInfo); ok {
		r0 = rf(_a0)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(*util.Deposit) error); ok {
		r1 = rf(_a0)
	} else {
		r1 = ret.Error(1)
	}
...
func (_m *WebhooksClient) PostPaymentIntentHook(_a0 *util.PaymentIntent) (*clients.WebhookInfo, error) {
	ret := _m.Called(_a0)
	...
	var r0 *clients.WebhookInfo
	var r1 error
	if rf, ok := ret.Get(0).(func(*util.PaymentIntent) (*clients.WebhookInfo, error)); ok {
		return rf(_a0)
	}
	if rf, ok := ret.Get(0).(func(*util.PaymentIntent) *clients.WebhookInfo); ok {
		r0 = rf(_a0)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*clients.WebhookInfo)
	...
	if rf, ok := ret.Get(1).(func(*util.PaymentIntent) error); ok {
		r1 = rf(_a0)
	} else {
		r1 = ret.Error(1)
	}
