...
replace github.com/ukama/ukama/testing/services/dummy-node/node => ../node
...
require (
	...
	github.com/ukama/ukama/testing/services/dummy-node/node v0.0.0-00010101000000-000000000000
