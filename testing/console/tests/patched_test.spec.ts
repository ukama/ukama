...
test('Onboarding Test', async ({ page }) => {
  ...
  await page.goto('http://localhost:3000/configure?step=2&flow=onb');
  await page
  ...
  await page
    ...
    .setInputFiles(
      '/Users/salmannaseem/Documents/Github/ukama/ukama/testing/console/test-temp/Sims_7.csv',
    );
  await page.locator('div').nth(1).setInputFiles('100Sims_part_4.csv');
