...
typedef struct {
    ...
    char         restart_reason[ULAB_MAX_ERR];
    char         rf_reason[ULAB_MAX_ERR];
    char         service_reason[ULAB_MAX_ERR];
