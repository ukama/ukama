...
const AddNodeForm = ({
  ...
  const handleAddClick = () => {
    setAttachedAmplierNode([...attachedAmplierNode, { nodeId: '', name: '' }]);
  };
      ...
      {nodeType == 'AMPLIFIER' && (
        <Grid item xs={12}>
          <FormControl variant="outlined" className={classes.formControl}>
            <InputLabel shrink variant="outlined" htmlFor="associatedTowerNode">
                ...
                towerNodesArrayList.map(({ id, name }: any) => (
                  <MenuItem value={name} key={id}>
                    <Typography variant="body1">
                      {towerNodesArrayList.length ? name : 'hello'}
                    </Typography>
                  </MenuItem>
                ))}
              <Divider />
              ...
              >
                <Stack direction="row" justifyContent="space-between">
                  ...
                  >
                    ...
                    {nodeType == 'AMPLIFIER' && 'New Tower Node'}
                  </Typography>
                  <IconButton
                    color="primary"
              ...
              <Fragment key={i}>
                ...
                <Grid item xs={12} md={8}>
                  <TextField
                    ...
                    id={'nodeId'}
                    name={isAssociatedTowerNode ? 'TOWER' : 'AMPLIFIER'}
                    spellCheck={false}
                    InputProps={{
