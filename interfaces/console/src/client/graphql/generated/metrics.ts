 ...
 * });
 */
export function useGetLatestMetricQuery(baseOptions: Apollo.QueryHookOptions<GetLatestMetricQuery, GetLatestMetricQueryVariables> & ({ variables: GetLatestMetricQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
...
export function useGetLatestMetricSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<GetLatestMetricQuery, GetLatestMetricQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<GetLatestMetricQuery, GetLatestMetricQueryVariables>(GetLatestMetricDocument, options);
        }
...
export type GetLatestMetricSuspenseQueryHookResult = ReturnType<typeof useGetLatestMetricSuspenseQuery>;
...
export function useGetStatsMetricSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<GetStatsMetricQuery, GetStatsMetricQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<GetStatsMetricQuery, GetStatsMetricQueryVariables>(GetStatsMetricDocument, options);
        }
...
export type GetStatsMetricSuspenseQueryHookResult = ReturnType<typeof useGetStatsMetricSuspenseQuery>;
