...
export default function UnitRFStatusCard() {
  return (
    <CardUI sx={{ fontFamily: "monospace" }}>
      <StatTitle label="UNIT RF STATUS" icon="📡" />
      <Typography variant="subtitle1" sx={{ fontWeight: 700, letterSpacing: 0.5, mb: 1 }}>
        🟢 Healthy
      </Typography>
      <Typography variant="body2" sx={{ mb: 1, lineHeight: 1.6 }}>
        RF transmission and amplification operating normally.
      </Typography>
      <Typography variant="body2" sx={{ fontWeight: 500, mb: 0.5 }}>
        Service impact (customer-facing):
      </Typography>
      <Typography variant="body2" sx={{ mb: 1.5, lineHeight: 1.6 }}>
        No RF-related service degradation.
      </Typography>
      <Typography variant="body2" sx={{ mb: 0.5 }}>
        Severity: Healthy
      </Typography>
      <Box sx={{ display: "flex", flexWrap: "wrap", justifyContent: "space-between", gap: 1 }}>
        <Typography variant="body2">Last evaluated: 2 min ago</Typography>
        <Typography variant="body2">Confidence: High (0.93)</Typography>
      </Box>
    </CardUI>
  );
}
