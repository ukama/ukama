...
import { ContainerJustifySpaceBtw, globalUseStyles } from '@/styles/global';
      ...
      {({
        ...
        <form onSubmit={handleSubmit}>
          <Grid container spacing={2}>
            ...
            <Grid item xs={12} container spacing={2} sx={{ mb: 1 / 2 }}>
              <Grid item xs={6}>
              ...
              <Grid item xs={6}>
                <Paper variant="outlined">
                  <Stack direction="row" spacing={1} alignItems="center">
                    <Radio
                      checked={selectedSimType === 'physicalSim'}
                      onChange={handleSimTypeChange}
                      value="physicalSim"
                      name="physicalSim"
                      inputProps={{
                    ...
                    />
                    <Typography variant="body1">
                      {`   Physical SIM (${physicalSimLeft || 0} left) `}
                    </Typography>
                  </Stack>
                </Paper>
              </Grid>
            ...
            <Grid item xs={12}>
              <ContainerJustifySpaceBtw sx={{ alignItems: 'end' }}>
                <Stack display="flex" alignItems="flex-start">
                  ...
                  <Typography variant="body1">
                    Roaming allows user to do xyz. Insert billing information.
                  </Typography>
                </Stack>
                <Switch
                  size="small"
              ...
              <Stack
                direction="row"
                justifyContent={!isAddUser ? 'space-between' : 'flex-end'}
                mt={1}
              >
                {!isAddUser && (
                  <Button
                ...
                <Stack direction="row" spacing={3}>
                  <Button
                    variant="text"
                    disabled={loading}
                    onClick={!isAddUser ? handleSkip : handleClose}
                  >
