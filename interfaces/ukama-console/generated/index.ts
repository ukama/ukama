...
export type NodesBySiteResDto = {
  __typename?: 'NodesBySiteResDto';
  nodes: Array<Node>;
...
export type QueryGetNodesBySiteArgs = {
...
export type GetInvitationsByOrgQuery = { __typename?: 'Query', getInvitationsByOrg: { __typename?: 'InvitationsResDto', invitations: Array<{ __typename?: 'InvitationsByOrgDto', name: string, email: string, link: string, role: string, expires_at: string, status: string, org: string, id: string, userId: string }> } };
...
export type GetInvitationByIdQuery = { __typename?: 'Query', getInvitationById: { __typename?: 'InvitationResDto', invitation: { __typename?: 'InvitationDto', name: string, email: string, link: string, expires_at: string, status: string, org: string, id: string, role: string, userId: string } } };

export type OrgInvitationsFragment = { __typename?: 'InvitationsByOrgDto', name: string, email: string, link: string, role: string, expires_at: string, status: string, org: string, id: string, userId: string };
...
/**
 * __useGetNodesBySiteQuery__
 *
 * To run a query within a React component, call `useGetNodesBySiteQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetNodesBySiteQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetNodesBySiteQuery({
 *   variables: {
 *      siteId: // value for 'siteId'
 *   },
 * });
 */
export function useGetNodesBySiteQuery(baseOptions: Apollo.QueryHookOptions<GetNodesBySiteQuery, GetNodesBySiteQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetNodesBySiteQuery, GetNodesBySiteQueryVariables>(GetNodesBySiteDocument, options);
      }
export function useGetNodesBySiteLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetNodesBySiteQuery, GetNodesBySiteQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetNodesBySiteQuery, GetNodesBySiteQueryVariables>(GetNodesBySiteDocument, options);
        }
