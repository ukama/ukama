...
export type OnboardingStatusQuery = { __typename?: 'Query', onboardingStatus: { __typename?: 'OnboardingStatusDto', hasNetwork: boolean, hasSite: boolean, hasNode: boolean, networkId?: string | null, networkName?: string | null } };
...
// @ts-ignore
export function useOnboardingStatusSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<OnboardingStatusQuery, OnboardingStatusQueryVariables>): Apollo.UseSuspenseQueryResult<OnboardingStatusQuery, OnboardingStatusQueryVariables>;
export function useOnboardingStatusSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<OnboardingStatusQuery, OnboardingStatusQueryVariables>): Apollo.UseSuspenseQueryResult<OnboardingStatusQuery | undefined, OnboardingStatusQueryVariables>;
export function useOnboardingStatusSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<OnboardingStatusQuery, OnboardingStatusQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<OnboardingStatusQuery, OnboardingStatusQueryVariables>(OnboardingStatusDocument, options);
        }
...
export type OnboardingStatusSuspenseQueryHookResult = ReturnType<typeof useOnboardingStatusSuspenseQuery>;
