export default function Page() {
  return (
    <div>
      <h1>Home page is under modification</h1>
    </div>
  );
}
...
//   UserInputDto,
// } from '@/generated';
// import { DataBilling, UsersWithBG } from '@/public/svg';
...
//       onCompleted: (res) => {
//         setServiceStatusIndicator(res.updateUserStatus.ukama.services.data);
//         if (res) {
//           setSelectedUser({
//             ...selectedUser,
...
//   useEffect(() => {
//     if (nodeRes && nodeRes.getNodesByOrg.nodes.length > 0 && !getMetricsRes) {
//       getMetrics({
//         variables: {
...
//           let data = { ...prev };
//           const latestNewtworkStatus = subscriptionData.data.getNetworkStatus;
...
//       updateQuery: (prev, { subscriptionData }) => {
//         let data = { ...prev };
//         const latestConnectedUser = subscriptionData.data.getConnectedUsers;
...
//             statusType={networkStatusRes?.getNetworkStatus?.status || undefined}
//             liveNodes={
//               networkStatusRes?.getNetworkStatus?.liveNode || undefined
//             }
//             totalNodes={
//               networkStatusRes?.getNetworkStatus?.totalNodes || undefined
//             }
//           />
//         </Grid>
//         <Grid
...
//             <StatusCard
//               title={'Data Usage'}
//               subtitle1={`${dataUsageRes?.getDataUsage?.dataConsumed || 0}`}
...
//             <StatusCard
//               title={'Data Bill'}
//               subtitle1={`$ ${dataBillingRes?.getDataBill?.dataBill || 0}`}
//               subtitle2={
...
//           handlePhysicalSimInstallationFlow1={handlePhysicalSimEmailFlow}
//           handlePhysicalSimInstallationFlow2={handlePhysicalSimSecurityFlow}
//           step={simFlow}
