...
void test_anode() {
    ...
    SystemdbMap sysdbmap[2] = { { "UK5001-RFCTRL", "/tmp/sys/anode-systemdb",
                                  MOD_CAP_AUTONOMOUS, MOD_MODE_MASTER },
                                { "UK4001-RFFE", "", MOD_CAP_DEPENDENT,
                                  MOD_MODE_SLAVE } };
...
void test_tnode() {
    ...
    SystemdbMap sysdbmap[3] = {
        { "UK1001-COMV1", "/tmp/sys/cnode-systemdb", MOD_CAP_AUTONOMOUS,
          MOD_MODE_MASTER },
        { "UK3001-MASK", "", MOD_CAP_DEPENDENT, MOD_MODE_SLAVE },
        { "UK2001-LTE", "", MOD_CAP_AUTONOMOUS, MOD_MODE_SLAVE }
    };
