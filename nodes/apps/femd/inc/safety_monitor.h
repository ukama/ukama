...
int safety_monitor_load_yaml_config(SafetyMonitor *monitor,
                                    const char *yaml_file);
int safety_monitor_set_thresholds(SafetyMonitor *monitor,
                                  float max_reverse_power,
                                  float max_current, float max_temp);
int safety_monitor_set_interval(SafetyMonitor *monitor,
                                uint32_t interval_ms);
int safety_monitor_enable(SafetyMonitor *monitor,
                          bool enabled);
int safety_monitor_get_config(SafetyMonitor *monitor,
                              SafetyConfig *config);
...
int safety_monitor_check_fem_unit(SafetyMonitor *monitor,
                                  FemUnit unit);
int safety_monitor_check_reverse_power(SafetyMonitor *monitor,
                                       FemUnit unit);
int safety_monitor_check_pa_current(SafetyMonitor *monitor,
                                    FemUnit unit);
int safety_monitor_check_temperature(SafetyMonitor *monitor,
                                     FemUnit unit);

int safety_monitor_shutdown_pa(SafetyMonitor *monitor,
                               FemUnit unit,
                               SafetyViolationType reason);
int safety_monitor_restore_pa(SafetyMonitor *monitor,
                              FemUnit unit);
bool safety_monitor_is_pa_shutdown(SafetyMonitor *monitor,
                                   FemUnit unit);

int safety_monitor_get_status(SafetyMonitor *monitor,
                              char *status_json,
                              size_t max_len);
