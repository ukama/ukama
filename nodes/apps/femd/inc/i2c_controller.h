...
int dac_get_config(I2cBus *bus, float *carrier, float *peak);
...
int eeprom_write_serial(I2cBus *bus, const char *serial);
int eeprom_read_serial(I2cBus *bus, char *serial, size_t maxLen);
