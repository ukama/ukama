...
typedef uint32_t (*command_handler_t) (char * args, void * user_data, void* reqCtx );
...
uint32_t handle_request_command(command_desc_t * commandArray, char * buffer, void* reqCtx);
