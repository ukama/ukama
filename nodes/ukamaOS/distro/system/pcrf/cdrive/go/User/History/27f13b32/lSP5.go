...
func deleteFlowfromSwitch(a *OfActor, ip net.IP) error {
...
func deleteFlowFromTable() {
	...
	if err != nil {
		log.Errorf("Failes to remove flow for UE %s from the table.", ipString)
		return err
	}
}
