...
func AddFlowForUe(a *OfActor, ipString string, meter uint32) err {
...
func DeleteFlowForUe(a *OfActor, ipString string, meter uint32) err {
	err := updateFlowForUe(a, ipString, meter, openflow15.FC_ADD)
	if err != nil {
...
func start() {
	...
	err = delFlowForUe(sw.ofActor, "192.168.8.3", id)
	if err != nil {
		log.Errorf("Failed to add  flow.")
	}
