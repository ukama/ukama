...
static const struct soc_gpio_map gpscore_gpio_map[] = {
	GPIO_NC,		/* GPIO_S0_SC[000]		SATA_GP[0]		-			-			- */
	GPIO_NC,		/* GPIO_S0_SC[001]		SATA_GP[1]		SATA_DEVSLP[0]		-			- */
	...
	GPIO_FUNC2,		/* GPIO_S0_SC[007]		RESERVED		SD3_WP			-			- */
	GPIO_NC,		/* GPIO_S0_SC[008]		I2S0_CLK		HDA_RST#		-			- */
	GPIO_NC,		/* GPIO_S0_SC[009]		I2S0_FRM		HDA_SYNC		-			- */
	GPIO_NC,		/* GPIO_S0_SC[010]		I2S0_DATAOUT		HDA_CLK			-			- */
	GPIO_NC,		/* GPIO_S0_SC[011]		I2S0_DATAIN		HDA_SDO			-			- */
	GPIO_NC,		/* GPIO_S0_SC[012]		I2S1_CLK		HDA_SDI[0]		-			- */
	...
	GPIO_FUNC3,		/* GPIO_S0_SC[016]		MMC1_CLK		-			MMC1_45_CLK		- */
	GPIO_FUNC3,		/* GPIO_S0_SC[017]		MMC1_D[0]		-			MMC1_45_D[0]		- */
	GPIO_FUNC3,		/* GPIO_S0_SC[018]		MMC1_D[1]		-			MMC1_45_D[1]		- */
	GPIO_FUNC3,		/* GPIO_S0_SC[019]		MMC1_D[2]		-			MMC1_45_D[2]		- */
	GPIO_FUNC3,		/* GPIO_S0_SC[020]		MMC1_D[3]		-			MMC1_45_D[3]		- */
	GPIO_FUNC3,		/* GPIO_S0_SC[021]		MMC1_D[4]		-			MMC1_45_D[4]		- */
	GPIO_FUNC3,		/* GPIO_S0_SC[022]		MMC1_D[5]		-			MMC1_45_D[5]		- */
	GPIO_FUNC3,		/* GPIO_S0_SC[023]		MMC1_D[6]		-			MMC1_45_D[6]		- */
	GPIO_FUNC3,		/* GPIO_S0_SC[024]		MMC1_D[7]		-			MMC1_45_D[7]		- */
	GPIO_FUNC3,		/* GPIO_S0_SC[025]		MMC1_CMD		-			MMC1_45_CMD		- */
	GPIO_FUNC3,		/* GPIO_S0_SC[026]		MMC1_RST#		SATA_DEVSLP[0]		MMC1_45_RST#		- */
	GPIO_NC,		/* GPIO_S0_SC[027]		SD2_CLK			-			-			- */
	GPIO_NC,		/* GPIO_S0_SC[028]		SD2_D[0]		-			-			- */
	GPIO_NC,		/* GPIO_S0_SC[029]		SD2_D[1]		-			-			- */
	GPIO_NC,		/* GPIO_S0_SC[030]		SD2_D[2]		-			-			- */
	GPIO_NC,		/* GPIO_S0_SC[031]		SD2_D[3]_CD#		-			-			- */
	GPIO_NC,		/* GPIO_S0_SC[032]		SD2_CMD			-			-			- */
	GPIO_FUNC1,		/* GPIO_S0_SC[033]		SD3_CLK			-			-			- */
	GPIO_FUNC1,		/* GPIO_S0_SC[034]		SD3_D[0]		-			-			- */
	GPIO_FUNC1,		/* GPIO_S0_SC[035]		SD3_D[1]		-			-			- */
	GPIO_FUNC1,		/* GPIO_S0_SC[036]		SD3_D[2]		-			-			- */
	GPIO_FUNC1,		/* GPIO_S0_SC[037]		SD3_D[3]		-			-			- */
	GPIO_FUNC1,		/* GPIO_S0_SC[038]		SD3_CD#			-			-			- */
	GPIO_FUNC1,		/* GPIO_S0_SC[039]		SD3_CMD			-			-			- */
	GPIO_FUNC1,		/* GPIO_S0_SC[040]		SD3_1P8EN		-			-			- */
	...
	GPIO_NC,		/* GPIO_S0_SC[048]		ILB_LPC_CLK[1]		-			-			- */
	...
	GPIO_NC,		/* GPIO_S0_SC[054]		ILB_8254_SPKR		RESERVED		-			- */
	...
	GPIO_NC,		/* GPIO_S0_SC[074]		SIO_UART2_RXD		-			-			- */
	GPIO_NC,		/* GPIO_S0_SC[075]		SIO_UART2_TXD		-			-			- */
	GPIO_NC,		/* GPIO_S0_SC[076]		SIO_UART2_RTS#		-			-			- */
	GPIO_NC,		/* GPIO_S0_SC[077]		SIO_UART2_CTS#		-			-			- */
	...
	GPIO_NC,		/* GPIO_S0_SC[090]		SIO_I2C6_DATA		ILB_NMI			-			- */
	GPIO_NC,		/* GPIO_S0_SC[091]		SIO_I2C6_CLK		SD3_WP			-			- */
	GPIO_NC,		/* RESERVED			GPIO_S0_SC[092]		-			-			- */
	GPIO_NC,		/* RESERVED			GPIO_S0_SC[093]		-			-			- */
...
static const struct soc_gpio_map gpssus_gpio_map[] = {
	...
	GPIO_NC,	/* GPIO_S5[01]		RESERVED		RESERVED	RESERVED	PMC_WAKE_PCIE[1]# 	*/
	...
	GPIO_DEFAULT,	/* GPIO_S5[08]		RESERVED		RESERVED	RESERVED	RESERVED 		*/
	...
	GPIO_NC,	/* RESERVED		GPIO_S5[13]		-		-		- 			*/
	GPIO_FUNC2,	/* RESERVED		GPIO_S5[14]		USB_ULPI_RST#	-		- 			*/
	GPIO_FUNC0,	/* PMC_WAKE_PCIE[0]#	GPIO_S5[15]		-		-		- 			*/
	GPIO_FUNC0,	/* PMC_PWRBTN#		GPIO_S5[16]		-		-		- 			*/
	GPIO_FUNC1,	/* RESERVED		GPIO_S5[17]		-		-		- 			*/
	GPIO_FUNC0,	/* PMC_SUS_STAT#	GPIO_S5[18]		-		-		- 			*/
	GPIO_FUNC0,	/* USB_OC[0]#		GPIO_S5[19]		-		-		- 			*/
	GPIO_FUNC0,	/* USB_OC[1]#		GPIO_S5[20]		-		-		- 			*/
	GPIO_NC,	/* PCU_SPI_CS[1]#	GPIO_S5[21]		-		-		- 			*/
	GPIO_NC,	/* GPIO_S5[22]		RESERVED		RESERVED	RESERVED	RESERVED 		*/
	GPIO_NC,	/* GPIO_S5[23]		RESERVED		RESERVED	RESERVED	RESERVED 		*/
	GPIO_NC,	/* GPIO_S5[24]		RESERVED		RESERVED	RESERVED	RESERVED 		*/
	GPIO_DEFAULT,	/* GPIO_S5[25]		RESERVED		RESERVED	RESERVED	RESERVED 		*/
	GPIO_NC,	/* GPIO_S5[26]		RESERVED		RESERVED	RESERVED	RESERVED 		*/
	GPIO_NC,	/* GPIO_S5[27]		RESERVED		RESERVED	RESERVED	RESERVED 		*/
	GPIO_NC,	/* GPIO_S5[28]		RESERVED		RESERVED	RESERVED	RESERVED 		*/
	GPIO_NC,	/* GPIO_S5[29]		RESERVED		RESERVED	RESERVED	RESERVED 		*/
	GPIO_NC,	/* GPIO_S5[30]		RESERVED		RESERVED	RESERVED	RESERVED 		*/
	GPIO_FUNC1,	/* GPIO_S5[31]		USB_ULPI_CLK		RESERVED	RESERVED	- 			*/
