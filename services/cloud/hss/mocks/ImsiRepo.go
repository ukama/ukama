...
// NewImsiRepo creates a new instance of ImsiRepo. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewImsiRepo(t testing.TB) *ImsiRepo {
	mock := &ImsiRepo{}
	mock.Mock.Test(t)
