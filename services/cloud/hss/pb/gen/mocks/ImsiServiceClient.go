...
// NewImsiServiceClient creates a new instance of ImsiServiceClient. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewImsiServiceClient(t testing.TB) *ImsiServiceClient {
