...
func (_m *RegistryServiceServer) List(_a0 context.Context, _a1 *gen.ListRequest) (*gen.ListResponse, error) {
	ret := _m.Called(_a0, _a1)
...
// NewRegistryServiceServer creates a new instance of RegistryServiceServer. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewRegistryServiceServer(t testing.TB) *RegistryServiceServer {
