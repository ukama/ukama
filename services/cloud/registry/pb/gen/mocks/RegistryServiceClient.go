...
func (_m *RegistryServiceClient) List(ctx context.Context, in *gen.ListRequest, opts ...grpc.CallOption) (*gen.ListResponse, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
...
// NewRegistryServiceClient creates a new instance of RegistryServiceClient. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewRegistryServiceClient(t testing.TB) *RegistryServiceClient {
