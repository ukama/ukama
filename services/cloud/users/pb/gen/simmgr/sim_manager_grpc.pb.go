...
func (c *simManagerServiceClient) TerminateSim(ctx context.Context, in *TerminateSimRequest, opts ...grpc.CallOption) (*TerminateSimResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/ukama.sim_manager.v1.SimManagerService/TerminateSim", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *simManagerServiceClient) GetUsage(ctx context.Context, in *GetUsageRequest, opts ...grpc.CallOption) (*GetUsageResponse, error) {
	out := new(GetUsageResponse)
	err := c.cc.Invoke(ctx, "/ukama.sim_manager.v1.SimManagerService/GetUsage", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _SimManagerService_GetSimStatus_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ukama.sim_manager.v1.SimManagerService/GetSimStatus",
	}
...
func _SimManagerService_TerminateSim_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ukama.sim_manager.v1.SimManagerService/TerminateSim",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _SimManagerService_GetUsage_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetUsageRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SimManagerServiceServer).GetUsage(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ukama.sim_manager.v1.SimManagerService/GetUsage",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SimManagerServiceServer).GetUsage(ctx, req.(*GetUsageRequest))
	}
	return interceptor(ctx, in, info, handler)
}
