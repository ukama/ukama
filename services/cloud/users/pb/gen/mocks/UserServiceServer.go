...
import (
	...
	gen "github.com/ukama/ukamaX/cloud/users/pb/gen"
...
// NewUserServiceServer creates a new instance of UserServiceServer. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewUserServiceServer(t testing.TB) *UserServiceServer {
