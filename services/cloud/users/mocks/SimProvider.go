...
// NewSimProvider creates a new instance of SimProvider. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewSimProvider(t testing.TB) *SimProvider {
	mock := &SimProvider{}
	mock.Mock.Test(t)
