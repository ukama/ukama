...
// NewNodeServiceClient creates a new instance of NodeServiceClient. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewNodeServiceClient(t testing.TB) *NodeServiceClient {
