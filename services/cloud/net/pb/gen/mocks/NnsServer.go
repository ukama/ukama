...
// NewNnsServer creates a new instance of NnsServer. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewNnsServer(t testing.TB) *NnsServer {
	mock := &NnsServer{}
	mock.Mock.Test(t)
