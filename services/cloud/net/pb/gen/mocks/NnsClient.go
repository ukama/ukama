...
// NewNnsClient creates a new instance of NnsClient. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewNnsClient(t testing.TB) *NnsClient {
	mock := &NnsClient{}
	mock.Mock.Test(t)
